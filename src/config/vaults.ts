...
export const VAULT_CONFIGS: VaultConfig[] = [
  {
    id: "main-vault",
    name: "Wave 4 AutoPrize Vault (LIVE!)",
    description:
      "Weekly autonomous prize draws with fair randomness and $0/month cost",
    address: "AS12mrFiqszWMeh1a6P44yTG9yMxXnnfSXAGyufh8g6112wu9HPYL",
    category: "weekly",
    drawPeriods: 37800, // ~7 days (604800 seconds / 16 seconds per period)
    tickPeriods: 225, // ~1 hour (3600 seconds / 16 seconds per period)
    minPrize: 100_000_000, // 0.1 MAS minimum prize
    color: "violet",
    icon: "💎",
    enabled: true,
  },
